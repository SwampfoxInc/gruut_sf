...
from gruut_sf.const import KNOWN_LANGS, TextProcessorSettings, Sentence
from gruut_sf.resources import _DIR, _PACKAGE
from gruut_sf.text_processor import TextProcessor
from gruut_sf.utils import resolve_lang
