#!/usr/bin/env python3
"""Command-line interface to gruut_sf"""
import argparse
import csv
import dataclasses
import logging
...
from gruut_sf.const import KNOWN_LANGS
from gruut_sf.text_processor import TextProcessor
from gruut_sf.utils import print_graph

# -----------------------------------------------------------------------------

_LOGGER = logging.getLogger("gruut_sf")

# Path to gruut_sf base directory
...
def get_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(prog="gruut_sf")
    parser.add_argument(
        "-l",
        "--language",
        default="en-us",
    ...
    parser.add_argument(
        "--model-prefix",
        help="Sub-directory of gruut_sf language data files with different lexicon, etc. (e.g., espeak)",
    )
    parser.add_argument(
