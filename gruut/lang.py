...
EN_US_ADDRESS_ABBREVIATIONS: typing.Dict[str, str] = {
    ...
    "SE": "Southeast",
    "SW": "Southwest",
    # Street suffixes (USPS Pub 28 Appendix C, alphabetized)
    "ALY": "Alley",
    "ANX": "Annex",
    "ARC": "Arcade",
    "AVE": "Avenue",
    ...
    "CRST": "Crest",
    "CSWY": "Causeway",
    # CT conflicts with Court (street suffix wins over Connecticut)
    "CT": "Court",
    "CTR": "Center",
    "CTRS": "Centers",
    "CTS": "Courts",
    ...
    "KNL": "Knoll",
    "KNLS": "Knolls",
    # KY conflicts with Key (street suffix wins over Kentucky)
    "KY": "Key",
    "KYS": "Keys",
    "LAND": "Land",
    "LCK": "Lock",
    ...
    "MNRS": "Manors",
    "MSN": "Mission",
    # MT conflicts with Mount (street suffix wins over Montana)
    "MT": "Mount",
    "MTN": "Mountain",
    "MTNS": "Mountains",
    "MTWY": "Motorway",
    ...
    # CT/KY/MT also appear as street suffixes (Court/Key/Mount) above and are
    # resolved at dispatch time via EN_US_STATE_ABBREVIATIONS and a lookahead
    # for a following ZIP code.
    "AL": "Alabama",
    "AK": "Alaska",
    "AZ": "Arizona",
    "AR": "Arkansas",
...
def get_en_us_settings(lang_dir=None, **settings_args) -> TextProcessorSettings:
    ...
    settings_args = {
        ...
        "state_abbreviations": EN_US_STATE_ABBREVIATIONS,
        **settings_args,
    }
